...
using System.Drawing;
    ...
    protected void LlenarGrid()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT *  FROM equipos"))  // variable para los comandos
            {
            ...
            protected void Button1_Click(object sender, EventArgs e)
            {
                ...
                int resultado = Clases.equipos.agregar(tnombre.Text);
                ...
                {
                    alertas("Error al agregar equipo");
            ...
            protected void Button2_Click(object sender, EventArgs e)
            {
                 ...
                 int resultado = Clases.equipos.borrar(int.Parse(id.Text));
        ...
        {
            int resultado = Clases.equipos.consultatipofiltro(int.Parse(id.Text));
            ...
            {
                alertas("Error al consultar equipo");
        ...
        {
            int resultado = Clases.equipos.modificar(int.Parse(id.Text));
            ...
            {
                alertas("Error al tratar de modificar equipo");
